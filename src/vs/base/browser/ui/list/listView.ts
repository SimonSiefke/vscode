...
export class ListView<T> extends Disposable implements IListView<T> {
	...
	@memoize get onMouseClick(): Event<IListMouseEvent<T>> { return Event.map(this._store.add(new DomEmitter(this.domNode, 'click')).event, e => this.toMouseEvent(e), this._store); }
	@memoize get onMouseDblClick(): Event<IListMouseEvent<T>> { return Event.map(this._store.add(new DomEmitter(this.domNode, 'dblclick')).event, e => this.toMouseEvent(e), this._store); }
	@memoize get onMouseMiddleClick(): Event<IListMouseEvent<T>> { return Event.filter(Event.map(this._store.add(new DomEmitter(this.domNode, 'auxclick')).event, e => this.toMouseEvent(e as MouseEvent), this._store), e => e.browserEvent.button === 1, this._store); }
	@memoize get onMouseUp(): Event<IListMouseEvent<T>> { return Event.map(this._store.add(new DomEmitter(this.domNode, 'mouseup')).event, e => this.toMouseEvent(e), this._store); }
	@memoize get onMouseDown(): Event<IListMouseEvent<T>> { return Event.map(this._store.add(new DomEmitter(this.domNode, 'mousedown')).event, e => this.toMouseEvent(e), this._store); }
	@memoize get onMouseOver(): Event<IListMouseEvent<T>> { return Event.map(this._store.add(new DomEmitter(this.domNode, 'mouseover')).event, e => this.toMouseEvent(e), this._store); }
	@memoize get onMouseMove(): Event<IListMouseEvent<T>> { return Event.map(this._store.add(new DomEmitter(this.domNode, 'mousemove')).event, e => this.toMouseEvent(e), this._store); }
	@memoize get onMouseOut(): Event<IListMouseEvent<T>> { return Event.map(this._store.add(new DomEmitter(this.domNode, 'mouseout')).event, e => this.toMouseEvent(e), this._store); }
	@memoize get onContextMenu(): Event<IListMouseEvent<T> | IListGestureEvent<T>> { return Event.any<IListMouseEvent<any> | IListGestureEvent<any>>(Event.map(this._store.add(new DomEmitter(this.domNode, 'contextmenu')).event, e => this.toMouseEvent(e), this._store), Event.map(this._store.add(new DomEmitter(this.domNode, TouchEventType.Contextmenu)).event as Event<GestureEvent>, e => this.toGestureEvent(e), this._store)); }
	@memoize get onTouchStart(): Event<IListTouchEvent<T>> { return Event.map(this._store.add(new DomEmitter(this.domNode, 'touchstart')).event, e => this.toTouchEvent(e), this._store); }
	@memoize get onTap(): Event<IListGestureEvent<T>> { return Event.map(this._store.add(new DomEmitter(this.rowsContainer, TouchEventType.Tap)).event, e => this.toGestureEvent(e as GestureEvent), this._store); }
