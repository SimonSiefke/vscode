...
import { IPCClient, IPCMessage } from '../common/ipc.js';
...
export class Client extends IPCClient implements IDisposable {
	...
	private static createProtocol(): ElectronProtocol {
		const onMessage = Event.fromNodeEventEmitter<IPCMessage>(ipcRenderer, 'vscode:message', (_, message) => message as IPCMessage);
